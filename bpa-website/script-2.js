...
var windowWidthOne = window.innerWidth;
var windowHeightOne = window.innerHeight;

function init() {
    windowWidthOne = window.innerWidth;
    windowHeightOne = window.innerHeight;
    clock = new THREE.Clock();

    canvasElm = document.getElementById('canvas123');
    renderer = new THREE.WebGLRenderer();
    renderer.setSize(windowWidthOne, windowHeightOne);
